var createFFmpegCore = (function () {
  ...
  return function (createFFmpegCore) {
    ...
    e.wasmMemory
      ? (ya = e.wasmMemory)
      : (ya = new WebAssembly.Memory({ initial: Ta / 65536, maximum: 16384 }));
    ya && (Na = ya.buffer);
    Ta = Na.byteLength;
    Sa(Na);
    var H,
    ...
    var gb = chrome.runtime.getURL('dist/ffmpeg-core.wasm');
    if (!hb()) {
      var ib = gb;
    ...
    function rb(a, b) {
      ...
      E[(b + 32) >> 2] = 0;
      E[(b + 28) >> 2] =
        ((a.getTime() - Date.UTC(a.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5) | 0;
      rb.Hf || (rb.Hf = Ja('GMT'));
      E[(b + 40) >> 2] = rb.Hf;
      return b;
    }
    ...
    var Ib = {
      ...
      Kb = {
        ...
        flush: function (a) {
          a.output && 0 < a.output.length && (fa(Fa(a.output, 0)), (a.output = []));
        },
      },
      Lb = {
        zf: function (a, b) {
        ...
        createNode: function (a, b, c, d) {
          ...
          L.re ||
            (L.re = {
              ...
              link: { node: { oe: L.Vd.oe, ee: L.Vd.ee, readlink: L.Vd.readlink }, stream: {} },
              Kf: { node: { oe: L.Vd.oe, ee: L.Vd.ee }, stream: K.pg },
            });
          c = K.createNode(a, b, c, d);
          K.be(c.mode)
            ? ((c.Vd = L.re.dir.node), (c.Wd = L.re.dir.stream), (c.Ud = {}))
            : K.isFile(c.mode)
              ? ((c.Vd = L.re.file.node), (c.Wd = L.re.file.stream), (c.Zd = 0), (c.Ud = null))
              : K.xe(c.mode)
        ...
        Wd: {
          ...
          write: function (a, b, c, d, f, g) {
            ...
            if (b.subarray && (!a.Ud || a.Ud.subarray)) {
              ...
              if (0 === a.Zd && 0 === f) return ((a.Ud = b.slice(c, c + d)), (a.Zd = d));
          ...
          je: function (a, b, c) {
            1 === c ? (b += a.position) : 2 === c && K.isFile(a.node.mode) && (b += a.node.Zd);
      ...
      K = {
        ...
        ue: function (a) {
          for (var b; ; ) {
            if (K.$e(a))
              return ((a = a.ae.ag), b ? ('/' !== a[a.length - 1] ? a + '/' + b : a + b) : a);
            b = b ? a.name + '/' + b : a.name;
            a = a.parent;
          }
        },
        ...
        rmdir: function (a) {
          ...
          try {
            ...
            k(
              "FS.trackingDelegate['willDeletePath']('" + a + "') threw an exception: " + g.message,
            );
          }
          b.Vd.rmdir(b, c);
          K.nf(d);
        ...
        chmod: function (a, b, c) {
          var d;
          'string' === typeof a ? (d = K.Yd(a, { le: !c }).node) : (d = a);
          if (!d.Vd.ee) throw new K.Td(63);
          d.Vd.ee(d, { mode: (b & 4095) | (d.mode & -4096), timestamp: Date.now() });
        },
        lchmod: function (a, b) {
          K.chmod(a, b, !0);
        },
        ...
        chown: function (a, b, c, d) {
          var f;
          'string' === typeof a ? (f = K.Yd(a, { le: !d }).node) : (f = a);
          if (!f.Vd.ee) throw new K.Td(63);
          f.Vd.ee(f, { timestamp: Date.now() });
        },
        ...
        truncate: function (a, b) {
          if (0 > b) throw new K.Td(28);
          var c;
          'string' === typeof a ? (c = K.Yd(a, { le: !0 }).node) : (c = a);
          ...
          c.Vd.ee(c, { size: b, timestamp: Date.now() });
        },
        dh: function (a, b) {
          a = K.ne(a);
          if (!a) throw new K.Td(8);
        ...
        qh: function (a, b, c) {
          a = K.Yd(a, { le: !0 }).node;
          a.Vd.ee(a, { timestamp: Math.max(b, c) });
        },
        open: function (a, b, c, d, f) {
          ...
          !e.logReadFiles ||
            b & 1 ||
            (K.Af || (K.Af = {}),
            a in K.Af || ((K.Af[a] = 1), k('FS.trackingDelegate error on read file: ' + a)));
          try {
            K.de.onOpenFile &&
              ((f = 0),
        ...
        Ee: function (a, b, c, d, f, g) {
          if (0 !== (f & 2) && 0 === (g & 2) && 2 !== (a.flags & 2097155)) throw new K.Td(2);
        ...
        writeFile: function (a, b, c) {
          ...
          } else if (ArrayBuffer.isView(b)) K.write(a, b, 0, b.byteLength, void 0, c.og);
        ...
        vg: function () {
          e.stdin ? K.te('/dev', 'stdin', e.stdin) : K.symlink('/dev/tty', '/dev/stdin');
          e.stdout ? K.te('/dev', 'stdout', null, e.stdout) : K.symlink('/dev/tty', '/dev/stdout');
          e.stderr ? K.te('/dev', 'stderr', null, e.stderr) : K.symlink('/dev/tty1', '/dev/stderr');
          K.open('/dev/stdin', 'r');
          K.open('/dev/stdout', 'w');
          K.open('/dev/stderr', 'w');
        },
          ...
          g.prototype.Jf = function () {
            ...
            u.jg(function (w) {
              ...
              if ('undefined' === typeof u.Ce[w]) {
                var Va = u.Ce;
                if (D > N)
                  throw Error('invalid range (' + D + ', ' + N + ') or no bytes requested!');
                if (N > t - 1) throw Error('only ' + t + ' bytes available! programmer error!');
    ...
    var O = {
      ...
      createSocket: function (a, b, c) {
        ...
        c.Je = a;
        b = K.Mf({ path: b, node: c, flags: K.$f('r+'), seekable: !1, Wd: O.Wd });
        a.stream = b;
        return a;
      },
      Ag: function (a) {
      ...
      ge: {
        ...
        Bg: function (a, b) {
          function c() {
            ...
            try {
              for (var g = b.Ye.shift(); g; ) (b.socket.send(g), (g = b.Ye.shift()));
            } catch (h) {
              b.socket.close();
            }
          }
          function d(g) {
            ...
            114 === g[6] &&
            116 === g[7]
              ? ((g = (g[8] << 8) | g[9]), O.ge.cg(a, b), (b.port = g), O.ge.If(a, b))
              : (a.Ie.push({ $d: b.$d, port: b.port, data: g }),
        ...
        De: function (a, b, c) {
          switch (b) {
            case 21531:
              return ((b = 0), a.Ie.length && (b = a.Ie[0].data.length), (E[c >> 2] = b), 0);
            default:
              return 28;
          }
        },
        ...
        bind: function (a, b, c) {
          if ('undefined' !== typeof a.df || 'undefined' !== typeof a.Be) throw new K.Td(28);
          a.df = b;
          a.Be = c;
          if (2 === a.type) {
        ...
        listen: function (a) {
          ...
          a.ce = new b({ host: a.df, port: a.Be });
        ...
        Cf: function (a, b) {
          ...
          b = Math.min(b, d);
          var h = { buffer: new Uint8Array(g, f, b), $d: c.$d, port: c.port };
          1 === a.type && b < d && ((c.data = new Uint8Array(g, f + b, d - b)), a.Ie.unshift(c));
          return h;
        },
      },
    };
    ...
    function cc(a) {
      ...
      for (c = 0; 8 > c; c++)
        (0 === a[c] && (1 < c - f && (h = 0), (f = c), h++), h > d && ((d = h), (g = c - d + 1)));
      for (c = 0; 8 > c; c++)
        1 < d && 0 === a[c] && c >= g && c < g + d
          ? c === g && ((b += ':'), 0 === g && (b += ':'))
          : ((b += Number(dc(a[c] & 65535)).toString(16)), (b += 7 > c ? ':' : ''));
      return b;
    }
    function ec(a, b) {
      var c = Oa[a >> 1],
      ...
      switch (c) {
        case 2:
          if (16 !== b) return { Xd: 28 };
          a = E[(a + 4) >> 2];
          a = bc(a);
          break;
        case 10:
          if (28 !== b) return { Xd: 28 };
    ...
    function Ac(a, b, c, d) {
      if (c)
        if (((a = W.getUniform(P[a], R[b])), 'number' == typeof a || 'boolean' == typeof a))
          switch (d) {
            case 0:
              E[c >> 2] = a;
              break;
    ...
    function Cc(a, b, c, d, f) {
      ...
      return a.subarray(
        ...
        (f +
          d *
            ((c * ({ 5: 3, 6: 4, 8: 2, 29502: 3, 29504: 4 }[b - 6402] || 1) * (1 << g) + h - 1) &
              -h)) >>
          g,
      );
    }
    ...
    var qd = {
        ...
        try {
          for (
            var f = 0,
              ...
              w = 0,
              D = 0,
              N = (b ? E[b >> 2] : 0) | (c ? E[c >> 2] : 0) | (d ? E[d >> 2] : 0),
              Va =
                (b ? E[(b + 4) >> 2] : 0) | (c ? E[(c + 4) >> 2] : 0) | (d ? E[(d + 4) >> 2] : 0),
              F = 0;
            F < a;
            F++
          ) {
            ...
            if (32 > F ? N & S : Va & S) {
              ...
              ha & 1 && (32 > F ? g & S : h & S) && (32 > F ? (v |= S) : (C |= S), f++);
              ha & 4 && (32 > F ? m & S : r & S) && (32 > F ? (p |= S) : (u |= S), f++);
              ha & 2 && (32 > F ? q & S : t & S) && (32 > F ? (w |= S) : (D |= S), f++);
            }
          }
          b && ((E[b >> 2] = v), (E[(b + 4) >> 2] = C));
          c && ((E[c >> 2] = p), (E[(c + 4) >> 2] = u));
          ...
          return (('undefined' !== typeof K && oa instanceof K.Td) || n(oa), -oa.Xd);
        }
      },
      Ba: function (a, b) {
        try {
      ...
      Ia: function (a, b, c) {
        try {
          ...
          a = 0;
          for (var f = K.je(d, 0, 1), g = Math.floor(f / 280); g < d.we.length && a + 280 <= c; ) {
            var h = d.we[g];
            if ('.' === h[0]) {
              var m = 1;
              var r = 4;
        ...
        try {
          a: {
            ...
            if (0 !== (d & 16) && 0 !== a % 16384) var m = -28;
              ...
              Nb[r] = { Fg: r, Eg: b, lf: h, fd: f, Ng: c, flags: d, offset: g };
              m = r;
            }
          }
          return m;
        ...
        try {
          ...
          switch (a) {
            ...
            case 5:
              ...
              return t.stream.fd;
            case 6:
              return ((h = b()), (q = M()), M(), fc(q, h.family, $b(h.df || '0.0.0.0'), h.Be), 0);
            case 7:
              h = b();
              q = M();
              M();
            ...
            case 11:
              ...
              M();
              var p = c(!0);
              return p ? h.fe.Ef(h, x, v, C, p.$d, p.port) : K.write(h.stream, x, v, C);
            case 12:
              h = b();
              var u = M(),
                w = M();
            ...
            case 16:
              ...
              for (var Ia = 0, Q = 0; Q < ha; Q++) Ia += E[(aa + (8 * Q + 4)) >> 2];
            ...
            case 17:
              ...
              for (Q = 0; 0 < Vb && Q < ha; Q++)
                if (((Tb = E[(aa + 8 * Q) >> 2]), (Ub = E[(aa + (8 * Q + 4)) >> 2])))
                  ((C = Math.min(Ub, Vb)),
      ...
      jd: function (a, b, c, d, f, g, h, m) {
        W.compressedTexImage2D(a, b, c, d, f, g, m ? B.subarray(m, m + h) : null);
      },
      id: function (a, b, c, d, f, g, h, m, r) {
        W.compressedTexSubImage2D(a, b, c, d, f, g, h, r ? B.subarray(r, r + m) : null);
      },
      ...
      ad: function (a) {
        if (a) {
          var b = P[a];
          b ? (W.deleteProgram(b), (b.name = 0), (P[a] = null), (pc[a] = null)) : U(1281);
        }
      },
      la: function (a, b) {
        for (var c = 0; c < a; c++) {
            ...
            if (d)
              if (35716 == b)
                ...
                if (-1 == d.Qe) {
                  ...
                  for (b = d.Qe = 0; b < f; ++b)
                    d.Qe = Math.max(d.Qe, W.getActiveAttrib(a, b).name.length + 1);
                }
                E[c >> 2] = d.Qe;
              } else if (35381 == b) {
                if (-1 == d.Re)
                  for (a = P[a], f = W.getProgramParameter(a, 35382), b = d.Re = 0; b < f; ++b)
                    d.Re = Math.max(d.Re, W.getActiveUniformBlockName(a, b).length + 1);
                E[c >> 2] = d.Re;
      ...
      rc: function (a, b, c) {
        c
          ? 35716 == b
            ...
            : 35720 == b
              ? ((a = W.getShaderSource(T[a])), (E[c >> 2] = a ? a.length + 1 : 0))
      ...
      Xb: function (a) {
        W.linkProgram(P[a]);
        var b = P[a];
        a = pc[a] = { fg: {}, xf: 0, Qe: -1, Re: -1 };
        for (var c = a.fg, d = W.getProgramParameter(b, 35718), f = 0; f < d; ++f) {
          ...
          if (m) {
            ...
            for (var q = 1; q < g.size; ++q)
              ((m = W.getUniformLocation(b, h + '[' + q + ']')), (r = tc(R)), (R[r] = m));
          }
        }
      },
      Wb: function (a, b) {
      ...
      Ab: function (a, b, c) {
        if (288 >= b) for (var d = Dc[b - 1], f = 0; f < b; ++f) d[f] = G[(c + 4 * f) >> 2];
      ...
      yb: function (a, b, c) {
        if (288 >= b) for (var d = Ec[b - 1], f = 0; f < b; ++f) d[f] = E[(c + 4 * f) >> 2];
      ...
      Za: function (a, b) {
        W.vertexAttrib4f(a, G[b >> 2], G[(b + 4) >> 2], G[(b + 8) >> 2], G[(b + 12) >> 2]);
      },
      W: function (a, b) {
      ...
      A: function (a, b, c, d) {
        try {
          a: {
            for (var f = Qb(a), g = (a = 0); g < c; g++) {
              var h = K.write(f, x, E[(b + 8 * g) >> 2], E[(b + (8 * g + 4)) >> 2], void 0);
              if (0 > h) {
                var m = -1;
                break a;
              }
      ...
      r: function (a, b, c, d) {
        ...
        var g = 0,
          ...
          t = 0;
        c &&
          ((m = E[c >> 2]), (r = E[(c + 4) >> 2]), (q = E[(c + 8) >> 2]), (t = E[(c + 12) >> 2]));
        q && !t && (t = 2 === q ? 17 : 6);
        !q && t && (q = 17 === t ? 2 : 1);
        0 === t && (t = 6);
        0 === q && (q = 1);
        ...
        if (b && ((b = z(b)), (h = parseInt(b, 10)), isNaN(h))) return m & 1024 ? -2 : -8;
        if (!a)
          return (
            0 === r && (r = 2),
            0 === (m & 1) && (2 === r ? (g = Yc(2130706433)) : (g = [0, 0, 0, 1])),
            (a = f(r, q, t, null, g, h)),
            (E[d >> 2] = a),
            0
          );
      ...
      E: function (a) {
        ...
        0 > c
          ...
          : 0 < c != (m == d) &&
            ((g = Math.max(h, g)), b.setTime(b.getTime() + 6e4 * ((0 < c ? m : g) - d)));
        E[(a + 24) >> 2] = b.getDay();
      ...
      j: function (a, b, c, d) {
        function f(p, u, w) {
          for (p = 'number' === typeof p ? p.toString() : p || ''; p.length < u; ) p = w[0] + p;
          return p;
        }
        function g(p, u) {
          return f(p, u, '0');
        ...
        q = {
            ...
            return 0 > h(w, p)
              ? g(
                  Math.ceil(
                    (31 -
                      w.getDate() +
                      (Lc(Kc(p.getFullYear()) ? Mc : Nc, p.getMonth() - 1) - 31) +
                      p.getDate()) /
                      7,
                  ),
                  2,
          ...
          '%W': function (p) {
            var u = new Date(p.he, 0, 1),
              w = 1 === u.getDay() ? u : Qc(u, 0 === u.getDay() ? 1 : 7 - u.getDay() + 1);
            p = new Date(p.he + 1900, p.Ke, p.Ve);
            return 0 > h(w, p)
              ? g(
                  Math.ceil(
    ...
    function wd(a) {
          ...
          if (xd) {
            ...
            try {
              ...
              r instanceof da ||
                ('unwind' == r
                  ? (noExitRuntime = !0)
                  : ((c = r) && 'object' === typeof r && r.stack && (c = [r, r.stack]),
      ...
      if (!(0 < ab)) {
        if (e.preRun)
          for ('function' == typeof e.preRun && (e.preRun = [e.preRun]); e.preRun.length; ) $a();
        lb(Ua);
        0 < ab ||
          (e.setStatus
            ? (e.setStatus('Running...'),
